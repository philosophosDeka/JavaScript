...
// 전달 받은 함수에 전달 받은 값을 적용시키는 고차 함수
...
// 콜백 함수를 익명 함수 리터럴로 정의해 곧 바로 고차 함수에 전달하는 것이 일반적이다.
console.log(apply(function(value) {return value ** 2;}, 7));    // value = 7, 7의 제곱이 결과값으로 출력
